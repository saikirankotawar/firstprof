...
body
{
      background-image:url(resources/images/signupbackground.jpg);
  ...
  <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form:form action="SignUp" method="POST" accept-charset="utf-8" class="form" role="form" commandName="usersDetail">   
                 <center><img src="resources/images/signup.jpg" style="width:400px;height:200px"></center>
                  <h1 style="color:red">  ${message}</h1>
                    ...
                    <form:input type="email" path="email"  class="form-control input-lg" placeholder="Your Email" /><br><form:input type="password" path="password" value="" class="form-control input-lg" placeholder="Password" /><br>
...
<option value="2013">2013</option>
                    ...
                    <br> <label>Gender : </label>                    <label class="radio-inline">
