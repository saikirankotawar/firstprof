...
body
{
      background-image:url(resources/images/homepagebg1.jpg);
...
<title>Bags Hub</title>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
   <a class="navbar-brand" href="/FrontEnd1">BagsHub</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="/FrontEnd1">Home</a></li>
      <li><a href="login">Login</a></li>
      <li><a href="/FrontEnd1/Register">Register</a></li>
        </ul>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="resources/images/51.jpg" alt="Chania" style="width:800px; height:400px">
      ...
      <div class="item">
        <img src="resources/images/52.jpg" alt="Chania" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something"> -->
      ...
      <div class="item">
        <img src="resources/images/53.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!--  <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
      ...
      <div class="item">
        <img src="resources/images/54.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
...
<div>
 <center><h3>Featured Bags</h3></center>
<hr></hr>
</div>
<div class="container">
